$(document).ready(function () {
        ...
        initComplete: function () {
            ...
            api
                ...
                .each(function (colIdx) {
                    ...
                    $(
                        'input',
                        $('#datos .filters th').eq($(api.column(colIdx).header()).index())
                    )
                        .off('keyup change')
    ...
    $('#datos_haber thead tr')
        .clone(true)
        .addClass('filters')
        .appendTo('#datos_haber thead');

    var table = $('#datos_haber').DataTable({
        ...
        initComplete: function () {
            ...
            api
                ...
                .each(function (colIdx) {
                    // Set the header cell to contain the input element
                    var cell = $('#datos_haber .filters th').eq(
                        $(api.column(colIdx).header()).index()
                    );
                    ...
                    $(
                        'input',
                        $('#datos_haber .filters th').eq($(api.column(colIdx).header()).index())
                    )
                        .off('keyup change')
                        .on('keyup change', function (e) {
                            e.stopPropagation();
