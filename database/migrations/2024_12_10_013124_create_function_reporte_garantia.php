...
return new class extends Migration
{
    ...
    RETURNS TABLE(id integer, cod_aeropuerto character varying, id_cliente integer, cliente character varying, codigo_contrato character varying, garantia numeric, pagado numeric, saldo numeric, fecha_deposito date, cuenta character varying, numero_cuenta bigint) 
    LANGUAGE 'plpgsql'
    COST 100
