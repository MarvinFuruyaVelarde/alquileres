<?php $__env->startSection('titulo','Kardex Empleados'); ?>

<?php $__env->startSection('content'); ?>

<div class="pagetitle">
    <h1>Kardex Empleados</h1>
    <nav>
      <ol class="breadcrumb">
 ...
 <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Cosultar Kardex de Empleados</h5>
                            ...
                            <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <strong><?php echo e($e->cargo); ?></strong>
                                        </td>
                                    <td class="d-flex justify-content-center" >
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kardex.show')): ?>
                                            <a href="<?php echo e(route('kardex.show',$e->id)); ?>" class="btn btn-warning" title="Ver Kardex Digital del empleado"><i class="bi bi-file-earmark-person"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/kardex/index.blade.php ENDPATH**/ ?>