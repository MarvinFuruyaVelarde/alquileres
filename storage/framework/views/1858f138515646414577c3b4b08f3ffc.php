...
<div class="pagetitle">
    ...
    <div class="d-flex flex-row align-items-center justify-content-between">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Discapacidad</li>
        </ol>
        </nav>
    </div>
 </div><!-- End Page Title -->
 <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Documentos de discapacidad adjuntos</h5>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo e($e->cargo[0]->nombre); ?> <small>(<?php echo e($e->cargo[0]->tipo_cargo); ?>)</small></td>
                                <td class="d-flex justify-content-center" >
                                    <?php if($e->discapacitado): ?>
                                    <a href="<?php echo e(asset('discapacidad/'.$e->discapacitado->adjunto)); ?>" class="btn btn-info" title="Ver documento adjunto" target="_blank"><i class="bi bi-file-earmark-pdf"></i></a>
                                    <?php else: ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('discapacidades.create')): ?>
                                        <a href="<?php echo e(route('discapacidades.create',$e->id)); ?>" class="btn btn-warning" title="Adjuntar documento de discapacidad"><i class="bi bi-pencil-square"></i></a>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                </td>
                            </tr>
