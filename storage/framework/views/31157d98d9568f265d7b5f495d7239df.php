                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center" >
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('complementarios.create')): ?>
                                        <a href="<?php echo e(route('complementarios.create',$e->id)); ?>" class="btn btn-warning" title="Ver / Registrar un Documento Complementario"><i class="bi bi-cloud-upload"></i></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sistema_alquileres\resources\views/complementarios/empleados.blade.php ENDPATH**/ ?>