      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('buscar_empleado')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center" >
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('enfermedades.create')): ?>
                                    <a href="<?php echo e(route('enfermedades.create',$e->id)); ?>" class="btn btn-warning" title="Registrar Enfermedad Terminal"><i class="bi bi-check2-square"></i></a>
                                <?php endif; ?>
                            </td>
                        </tr>
