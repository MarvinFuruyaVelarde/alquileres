...
<?php $__env->startSection('titulo','Declaraciones Juradas'); ?>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center" >
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('declaraciones.create')): ?>
                                        <a href="<?php echo e(route('declaraciones.create',$e->id)); ?>" class="btn btn-warning" title="Ver / Registrar un DDJJ"><i class="bi bi-cloud-upload"></i></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/declaraciones/empleados.blade.php ENDPATH**/ ?>