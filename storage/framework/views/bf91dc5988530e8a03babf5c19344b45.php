  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo e(route('home')); ?>" class="logo d-flex align-items-center">
        <img src="<?php echo e(asset('assets/img/descarga1.png')); ?>" alt="">
...
</html><?php /**PATH C:\xampp\htdocs\laravel\sistema_alquileres\resources\views/layouts/app.blade.php ENDPATH**/ ?>