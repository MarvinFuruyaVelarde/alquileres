...
class Reporte extends Model
{
    ...
    {
        return DB::select('SELECT codigo, razon_social, gestion, mes_literal, numero_nota_cobro, tipo_factura, numero_factura, monto_total, estado FROM reporte_factura(?, ?)', [$gestion, $mes]);
    }
