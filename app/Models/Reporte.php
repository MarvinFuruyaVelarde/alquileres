...
class Reporte extends Model
{
    ...
    public static function reporteGarantia($aeropuerto = null, $cliente = null)
    {
        return DB::select('SELECT cod_aeropuerto, cliente, codigo_contrato, garantia, pagado, saldo, fecha_pago, fecha_deposito, cuenta, numero_cuenta FROM reporte_garantia(?, ?)', [$aeropuerto, $cliente]);
    }
    ...
    {
        return DB::select('SELECT cod_aeropuerto, desc_aeropuerto, total_ingreso, tipo_factura FROM reporte_ingreso_aeropuerto(?, ?, ?, ?)', [$aeropuerto, $fechaInicial, $fechaFinal, $tipoFactura]);
    }
    ...
    {
        return DB::select('SELECT codigo, cliente, tipo_factura, numero_factura, fecha_max_pago, fecha_actual, dia_mora, monto_a_pagar, monto_pagado, saldo, mora_generada, mora_por_generar, mora_total, fecha_pago FROM reporte_mora(?, ?)', [$aeropuerto, $cliente]);
    }
