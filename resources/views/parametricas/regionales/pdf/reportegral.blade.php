          ...
          <table class="title" style="width: 100%;">
             <tr class="items">
                   ...
                   <td style="width: 100%; text-align:center; font-weight: bold;">
                      ...
                      <div style="font-size: 15px">REGIONALES</div>
                   </td>
                   <!--<td style="width: 20%; text-align:center"> 
                   </td>-->
             </tr>
...
<table  style="width:100%; font-size:10">
    ...
    <tbody>
        ...
        <tr>
            <td style="text-align:center;">{{ $regional->id }}</td>
            <td style="text-align:center;">{{ $regional->codigo }}</td>
            <td style="text-align:center;">{{ $regional->descripcion }}</td>
            <td style="text-align:center;">{{ $regional->desc_estado }}</td>
        </tr>
        @endforeach
    </tbody>
 </table >