...
<div class="row mb-1">
    ...
    <div class="col-md-6">
        <input id="codigo" type="text" class="form-control{{ $errors->has('codigo') ? ' error' : '' }}" name="codigo" value="{{ old('codigo',$regional->codigo) }}" autofocus onkeyup="this.value = this.value.toUpperCase();">
...
<div class="row mb-1">
    ...
    <div class="col-md-6">
        <input id="descripcion" type="text" class="form-control {{ $errors->has('descripcion') ? ' error' : '' }}" name="descripcion" value="{{ old('descripcion',$regional->descripcion) }}" onkeyup="this.value = this.value.toUpperCase();">
