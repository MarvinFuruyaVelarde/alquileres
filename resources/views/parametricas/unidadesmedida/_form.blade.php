...
<div class="row mb-1">
    ...
    <div class="col-md-6">
        <input id="descripcion" type="text" class="form-control {{ $errors->has('descripcion') ? ' error' : '' }}" name="descripcion" value="{{ old('descripcion',$unidadmedida->descripcion) }}" autofocus onkeyup="this.value = this.value.toUpperCase();">
