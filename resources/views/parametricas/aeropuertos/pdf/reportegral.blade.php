          ...
          <table class="title" style="width: 100%;">
             <tr class="items">
                   ...
                   <td style="width: 100%; text-align:center; font-weight: bold;">
                      ...
                      <div style="font-size: 15px">AEROPUERTOS</div>
                   </td>
                   <!--<td style="width: 20%; text-align:center"> 
                   </td>-->
             </tr>
...
<table  style="width:100%; font-size:10">
    ...
    <tbody>
        ...
        <tr>
            <td style="text-align:center;">{{ $aeropuerto->id }}</td>
            <td style="text-align:center;">{{ $aeropuerto->codigo }}</td>
            <td style="text-align:center;">{{ $aeropuerto->descripcion }}</td>
            <td style="text-align:center;">{{ $aeropuerto->desc_regional }}</td>
            <td style="text-align:center;">{{ $aeropuerto->desc_estado }}</td>
        </tr>
        @endforeach
    </tbody>
 </table >