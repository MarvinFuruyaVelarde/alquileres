...
<div class="row mb-1">
    <label for="moneda" class="col-md-4 col-form-label text-right ">Moneda <span class="text-danger">(*)</span></label>
    <div class="col-md-6">
        <select id="moneda" class="form-control{{ $errors->has('moneda') ? ' error' : '' }}" name="moneda">
