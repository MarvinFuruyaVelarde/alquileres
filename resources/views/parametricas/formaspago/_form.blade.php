...
<div class="row mb-1">
    ...
    <div class="col-md-6">
        <input id="descripcion" type="text" class="form-control {{ $errors->has('descripcion') ? ' error' : '' }}" name="descripcion" value="{{ old('descripcion',$formapago->descripcion) }}" autofocus onkeyup="this.value = this.value.toUpperCase();">
...
<div class="row mb-1">
    <label for="numero_dia" class="col-md-4 col-form-label text-right ">Nro. Dias <span class="text-danger">(*)</span></label>
    <div class="col-md-6">
        <input id="numero_dia" type="text" class="form-control{{ $errors->has('numero_dia') ? ' error' : '' }}" name="numero_dia" value="{{ old('numero_dia',$formapago->numero_dia) }}" onkeyup="this.value = this.value.toUpperCase();">
