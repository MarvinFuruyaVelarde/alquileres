                    ...
                    <form action="" method="post">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="fecha_inicial" type="date" class="form-control {{ $errors->has('fecha_inicial') ? ' error' : '' }}" name="fecha_inicial" value="{{ old('fecha_inicial',$espacio->fecha_inicial) }}" disabled>
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="fecha_final" type="date" class="form-control {{ $errors->has('fecha_final') ? ' error' : '' }}" name="fecha_final" value="{{ old('fecha_final',$espacio->fecha_final) }}" disabled>
