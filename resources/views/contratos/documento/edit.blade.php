...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('documentocontratos.index') }}">Contratos</a></li>
        <li class="breadcrumb-item active">Documento Contrato</li>
      </ol>
    </nav>
 </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('documentocontratos.update', ['contrato' => $contrato->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT') 
                        ...
                        <div class="row mb-1">                        
                            <div class="col-md-4">
                                <label for="documento_contrato" class="col-form-label">Documento Contrato <span class="text-danger">(*)</span></label>
                                <input type="file" class="form-control" id="documento_contrato" name="documento_contrato" accept="application/pdf" required>
                            </div>                            
                        </div>
                        <br>
                        <div class="row mt-2">
                            <div class="text-center">
                                ...
                                <a href="{{ route('documentocontratos.index') }}" class="btn btn-warning">Cancelar</a>
                            </div>
                        </div>
