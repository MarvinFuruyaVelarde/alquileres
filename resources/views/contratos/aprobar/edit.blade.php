...
<div class="pagetitle">
    <h1>Aprobar Contrato</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('aprobarcontratos.index') }}">Contratos</a></li>
        <li class="breadcrumb-item active">Aprobar Contrato</li>
      </ol>
    </nav>
 </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('aprobarcontratos.update', ['contrato' => $contrato->id])}}" method="post">
                        @csrf
                        @method('PUT') 
