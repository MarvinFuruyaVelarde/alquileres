        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('contratos.store_espacio')}}" method="post">
                        @csrf
                                            ...
                                            <li>
                                                <div class="row mb-3 align-items-center">   
                                                    ...
                                                    <div class="col-md-4 d-flex align-items-center">
                                                        ...
                                                        <div class="form-check me-3">                                                    
                                                            <input id="tarifa_fija{{ $expensa->id }}"  class="form-check-input" type="radio" name="lista_expensas[{{ $expensa->id }}][tarifa_fija]" value="S" {{ ($espacio->tarifa_fija ?? '') == 'S' ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="tipo_canon1">Sí</label>                                                                                                                                                              
                                                        </div>
                                                        <div class="form-check">                                                
                                                            <input id="tarifa_fija{{ $expensa->id }}" class="form-check-input" type="radio" name="lista_expensas[{{ $expensa->id }}][tarifa_fija]" value="N" {{ ($espacio->tarifa_fija ?? 'N') == 'N' ? 'checked' : '' }}>
