      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <!--CONTENIDO -->
           {!! Form::open(['route'=>'contratos.store','class'=>'form-horizontal','id'=>'form_reg_contrato','data-form-id'=>'form_reg_contrato']) !!}
                @include('contratos.lista._form',['texto' => 'Guardar','color'=>'primary'])
            {!! Form::close() !!}
