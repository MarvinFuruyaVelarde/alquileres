             ...
             <tr class="items">
                <td style="width: 20%; text-align:center">
                   ...
                   <td style="width: 100%; text-align:center; font-weight: bold;">
                      ...
                      <div style="font-size: 14px">REPORTE DE DEUDAS</div>
                   </td>
                   <td style="width: 20%; text-align:center"> 
                   </td>
             </tr>
...
<table  style="width:100%; font-size:10">
    ...
    <tbody>
        ...
        <tr>
            <td style="text-align:center;">{{ $deuda->cod_aeropuerto }}</td>
            <td style="text-align:center;">{{ $deuda->desc_aeropuerto }}</td>
            <td style="text-align:center;">{{ $deuda->cliente }}</td>
            <td style="text-align:center;">{{ $deuda->total_deuda }}</td>
        </tr>
        @endforeach
    </tbody>
 </table >