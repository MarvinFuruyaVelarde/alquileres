@extends('layouts.app')
@section('titulo','Reporte de Deudas')
@section('content')
...
<div class="pagetitle">
    ...
    <div class="d-flex flex-row align-items-center justify-content-between">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Reporte de Deudas</li>
        </ol>
        </nav>
    </div>
...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Reporte de Deudas</h5>
                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">TOTAL DEUDA (BS)</th>
                                    </tr>
                                </thead>
                                <tbody id="dato">
...
<script>
    $(document).ready(function() {
        ...
        function actualizarReporte() {
            ...
            if (aeropuerto || cliente || (fechaInicial && fechaFinal)) {
                $.ajax({
                    url: '{{ url("reportedeudas/obtieneReporte/") }}',
                    method: 'get',
    ...
    function generarReporte(tipo) {
        ...
        let url = tipo === 'pdf' 
            ? "{{ route('reportedeudas.show') }}" 
            : "{{ route('reportedeudas.export') }}";
