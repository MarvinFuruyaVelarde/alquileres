...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Reporte de Mora</h5>
                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">FECHA MAX. PAGO</th>
                                        <th class="text-center">DIA(S) MORA</th>
...
<script>
    $(document).ready(function() {
        ...
        function actualizarReporte() {
            ...
            if (aeropuerto || cliente) {
                $.ajax({
                    url: '{{ url("reportemora/obtieneReporte/") }}',
                    method: 'get',
                ...
                data.forEach(function(item) {
                    grillaHtml += `
                        <tr>    
                            ...
                            <td class="text-center">${item.fecha_max_pago || ''}</td>
                            <td class="text-center">${item.dia_mora || ''}</td>
    ...
    function generarReporte(tipo) {
        ...
        let url = tipo === 'pdf' 
            ? "{{ route('reportemora.show') }}" 
            : "{{ route('reportemora.export') }}";
