...
<div class="pagetitle">
    ...
    <div class="d-flex flex-row align-items-center justify-content-between">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Reporte de Cuentas por Cobrar</li>
        </ol>
        </nav>
    </div>
                            ...
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">FECHA NOTA DE COBRO</th>
...
<script>
    $(document).ready(function() {
        ...
        function actualizarReporte() {
            ...
            if (aeropuerto || cliente || (fechaInicial && fechaFinal)) {
                $.ajax({
                    url: '{{ url("reportecuentaporcobrar/obtieneReporte/") }}',
                    method: 'get',
                ...
                data.forEach(function(item) {
                    grillaHtml += `
                        <tr>    
                            ...
                            <td class="text-center">${item.nit || item.ci || ''}</td>
    ...
    function generarReporte(tipo) {
        ...
        let url = tipo === 'pdf' 
            ? "{{ route('reportecuentaporcobrar.show') }}" 
            : "{{ route('reportecuentaporcobrar.export') }}";
