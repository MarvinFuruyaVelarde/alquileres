@extends('layouts.app')
@section('titulo','Reporte de Ingresos por Cliente')
@section('content')

@section('content')

<div class="pagetitle">
    <h1>Reporte de Ingresos por Cliente</h1>
    <div class="d-flex flex-row align-items-center justify-content-between">
        <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Inicio</a></li>
            <li class="breadcrumb-item active">Reporte de Ingresos por Cliente</li>
        </ol>
        </nav>
    </div>
...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Reporte de Ingresos por Cliente</h5>
...
<script>
    $(document).ready(function() {
        ...
        $('#aeropuerto, #cliente, #fecha_inicial, #fecha_final').change(function() {
            actualizarReporte();
        });
        ...
        function actualizarReporte() {
            ...
            if (aeropuerto || cliente || (fechaInicial && fechaFinal)) {
                $.ajax({
                    url: '{{ url("reporteingresoclientes/obtieneReporte/") }}',
                    method: 'get',
                    data: {'aeropuerto': aeropuerto, 'cliente': cliente, 'fechaInicial': fechaInicial, 'fechaFinal': fechaFinal},
    ...
    function generarReporte(tipo) {
        ...
        let url = tipo === 'pdf' 
            ? "{{ route('reporteingresoclientes.show') }}" 
            : "{{ route('reporteingresoclientes.export') }}";

        url += `?aeropuerto=${aeropuerto}&cliente=${cliente}&fechaInicial=${fechaInicial}&fechaFinal=${fechaFinal}`;
