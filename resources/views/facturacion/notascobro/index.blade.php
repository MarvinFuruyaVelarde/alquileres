 ...
 <section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('facturacion.aprobarNotaCobro')}}" method="POST">
                        @csrf
...
<script>
    ...
    function getCliente(aeropuerto, cliente=null) {
        ...
        $.ajax({
          url: '{{ url("facturacion/obt_cliente/") }}/'+aeropuerto+'/'+cliente,
          method: 'get',
    ...
    function generaNotaCobro(aeropuerto, periodoFacturacion, tipo) {
      ...
      $.ajax({
        url: '{{ route('facturacion.generaNotaCobro') }}',
        method: 'get',
    ...
    function visualizaNotaCobro(periodoFacturacion, tipo, aeropuerto, cliente) {
      ...
      $.ajax({
        url: '{{ route('facturacion.visualizaNotaCobro') }}',
        method: 'get',
